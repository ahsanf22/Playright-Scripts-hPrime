...
namespace HNE_PGY_Beta
{
    public class HNE_PGY_MidTA_Beta
    {
        ...
        public async Task Test1()
        {
            ...
            var username = "**********";
            var password = "**********";
            var reqsetup_Candidate = "JAMWeb, Automation1";
            var reqsetup_Assessor = "JAMWeb, Automation2";
            var reqsetup_DCT = "JAMWeb, Automation3";
            var imp_Candidate = "2915"; //AutomationUser, 3001
            var imp_Assessor = "2891"; //AutomationUser, 3002
            var imp_DCT = "2888"; //Bates, Timothy
            ...
            await page.Locator("#cphMain_ucRequirementDetails_rptIndividualForms_ddlForms_0").SelectOptionAsync(new[] { "309" }); //Mid TA Selection
            ...
            await page.ClickAsync("#ctl00_cphMain_ucRequirementDetails_rptIndividualForms_ctl01_ddlAssessors_Input");

            await page.WaitForSelectorAsync("#ctl00_cphMain_ucRequirementDetails_rptIndividualForms_ctl01_ddlAssessors_DropDown .rcbList", new PageWaitForSelectorOptions { Timeout = 5000 });

            await page.Locator("#ctl00_cphMain_ucRequirementDetails_rptIndividualForms_ctl01_ddlAssessors_DropDown .rcbItem").Filter(new() { HasText = reqsetup_Assessor }).ClickAsync();

            await page.ClickAsync("#ctl00_cphMain_ucRequirementDetails_rptIndividualForms_ctl01_ddlSignOff_Input");

            await page.WaitForSelectorAsync("#ctl00_cphMain_ucRequirementDetails_rptIndividualForms_ctl01_ddlSignOff_DropDown .rcbList", new PageWaitForSelectorOptions { Timeout = 5000 });

            await page.Locator("#ctl00_cphMain_ucRequirementDetails_rptIndividualForms_ctl01_ddlSignOff_DropDown .rcbItem").Filter(new() { HasText = reqsetup_DCT }).ClickAsync();
            ...
            await page.WaitForLoadStateAsync(LoadState.Load);
            Console.WriteLine("Impersonated to Assessor => " + imp_Candidate);
            ...
            await page.WaitForLoadStateAsync(LoadState.Load);
            Console.WriteLine("Mid TA Assessment Opened"); 
