...
{
    public class GC_PGY_EndTA_Beta
    {
        ...
        public async Task Test1()
        {
            ...
            await page.Locator("#cphMain_ucRequirementDetails_rptIndividualForms_ddlForms_0").SelectOptionAsync(new[] { "309" }); //End TA Selection
            ...
            Console.WriteLine("End TA Selected");
            ...
            //await page.Locator("#ctl00_cphMain_rgSearchResults_ctl00__0").GetByRole(AriaRole.Cell, new() { Name = ext_Ass_Lastname + ", " + ext_Ass_Firstname }).Nth(1).ClickAsync();
            ...
            await page.WaitForSelectorAsync("text=End Term Assessment Form", new PageWaitForSelectorOptions { Timeout = 25000 });
            ...
            //await page.GotoAsync("https://hp3-test.hprime.com.au//externalForm?id=VhYaiHTH2NE%3D&ea=zcxQ7vKMO8o%3D&cs=upne35C9HeIKKXAGyRgF%20g%3D%3D");
            ...
            await page.Locator(".cdk-textarea-autosize").First.FillAsync("QA ");
            ...
            await page.Locator("#mat-radio-21").GetByText("Often exceeded").ClickAsync();
            ...
            await page.GetByText("Unsatisfactory ( The").ClickAsync();
