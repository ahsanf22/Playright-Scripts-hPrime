...
{
    public class SJOG_PGY_EndTA_Beta
    {
        ...
        public async Task Test1()
        {
            ...
            await page.Locator("#cphMain_ucRequirementDetails_rptIndividualForms_ddlForms_0").SelectOptionAsync(new[] { "308" }); //End TA Selection
