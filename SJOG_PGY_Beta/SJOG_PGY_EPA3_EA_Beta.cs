...
{
    public class SJOG_PGY_EPA3_EA_Beta
    {
        ...
        public async Task Test1()
        {
            ...
            var ext_Assessor_Firstname = "JAMWeb";
            var ext_Assessor_Lastname = "Automation";
            var ext_Assessor_Email = "jamweb.automation@hprime.com.au";
            ...
            await page.WaitForSelectorAsync("text=EPA 3: Prescribing", new PageWaitForSelectorOptions { Timeout = 25000 });
            Console.WriteLine("Navigated to Create tab");

            //Run Flow (Select EPA 3)
            await page.GetByRole(AriaRole.Heading, new() { Name = "EPA 3: Prescribing" }).ClickAsync();
            ...
            Console.WriteLine("Assessor Selection Page, EPA 3 Opened");

            //Run Flow (Externl Assessor Details)
            await page.GetByRole(AriaRole.Textbox, new() { Name = "First name" }).FillAsync(ext_Assessor_Firstname);
            await page.GetByRole(AriaRole.Textbox, new() { Name = "Last name" }).FillAsync(ext_Assessor_Lastname);
            await page.GetByRole(AriaRole.Textbox, new() { Name = "Email" }).FillAsync(ext_Assessor_Email);
            ...
            await page.GetByText("1. Obtain and interpret").ClickAsync();
            await page.GetByText("2. Respond to requests from").ClickAsync();
            await page.GetByText("3. Consider whether a").ClickAsync();
            await page.GetByText("4. Choose appropriate").ClickAsync();
            await page.GetByText("5. Where appropriate, clarify").ClickAsync();
            await page.GetByText("6. Actively consider drug/").ClickAsync();
            await page.GetByText("7. Provide instruction on").ClickAsync();
            await page.GetByText("8. Elicit any patient").ClickAsync();
            await page.GetByText("9. Write or enter accurate").ClickAsync();
            await page.GetByText("10. Monitor medications for").ClickAsync();
            await page.GetByText("11. Review medications and").ClickAsync();
            ...
            Console.WriteLine("Opened Sent Email Page");
            ...
            await page.Locator("#ctl00_cphMain_rgSearchResults_ctl00_ctl02_ctl02_FilterTextBox_To").FillAsync(ext_Assessor_Email);
            ...
            await page.Locator("#ctl00_cphMain_rgSearchResults_ctl00__0").GetByRole(AriaRole.Cell, new() { Name = ext_Assessor_Lastname + ", " + ext_Assessor_Firstname }).ClickAsync();
            ...
            await page.WaitForSelectorAsync("text=" + ext_Assessor_Lastname + ", " + ext_Assessor_Firstname, new PageWaitForSelectorOptions { Timeout = 25000 });

            var linkElement = page.Locator("a:has-text('EPA 3: Prescribing')");
            ...
            // Navigate to the External Assessor URL for Approval
            ...
            await page.WaitForLoadStateAsync(LoadState.Load);
            Console.WriteLine("External Assessor Form Opened for approval");
            await page.WaitForSelectorAsync("text=" + headingText, new PageWaitForSelectorOptions { Timeout = 25000 });
            await page.GetByRole(AriaRole.Button, new() { Name = "Close", Exact = true }).ClickAsync();
            await page.GetByRole(AriaRole.Button, new() { Name = "Approve Form" }).ClickAsync();
            ...
            Console.WriteLine("Form Approved by External Assessor");
            Console.WriteLine("EPA 3 Completed");
