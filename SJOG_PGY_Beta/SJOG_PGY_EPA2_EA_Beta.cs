...
{
    public class SJOG_PGY_EPA2_EA_Beta
    {
        ...
        public async Task Test1()
        {
            ...
            await page.WaitForSelectorAsync("text=EPA 2: Recognition and care of the acutely unwell patient", new PageWaitForSelectorOptions { Timeout = 25000 });
            Console.WriteLine("Navigated to Create tab");

            //Run Flow (Select EPA 2)
            await page.GetByRole(AriaRole.Heading, new() { Name = "EPA 2: Recognition and care of the acutely unwell patient" }).ClickAsync();
            ...
            Console.WriteLine("Assessor Selection Page, EPA 2 Opened");
            ...
            await page.GetByText("1 Recognise clinical").ClickAsync();
            await page.GetByText("2 Respond by initiating").ClickAsync();
            await page.GetByText("3 Seek appropriate assistance").ClickAsync();
            await page.GetByText("4 Communicate critical").ClickAsync();
            await page.GetByText("5 Lead the resuscitation").ClickAsync();
            ...
            var linkElement = page.Locator("a:has-text('EPA 2: Recognition and care')");
            ...
            Console.WriteLine("EPA 2 Completed");
