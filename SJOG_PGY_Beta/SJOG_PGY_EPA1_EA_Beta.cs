...
{
    public class SJOG_PGY_EPA1_EA_Beta
    {
        ...
        public async Task Test1()
        {
            ...
            await page.WaitForSelectorAsync("text=EPA 1: Clinical Assessment", new PageWaitForSelectorOptions { Timeout = 25000 });
            Console.WriteLine("Navigated to Create tab");

            //Run Flow (Select EPA 1)
            await page.Locator("div.d-flex.list-hover.grey-bg", new() { HasTextString = "EPA 1: Clinical Assessment" }).ClickAsync();
            ...
            Console.WriteLine("Assessor Selection Page, EPA 1 Opened");
            ...
            await page.Locator("#mat-checkbox-25 > .mat-checkbox-layout > .mat-checkbox-inner-container").ClickAsync();
            ...
            Console.WriteLine("EPA 1 Completed");
